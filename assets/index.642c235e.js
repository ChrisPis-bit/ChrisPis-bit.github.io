...
The resulting renderer supports <strong>complex volumetric effects</strong> and achieves <strong>real-time performance</strong>. The project received a <strong>final grade of 10/10</strong>.`,media:"https://github.com/user-attachments/assets/dca3e0d9-5420-4f9d-9205-d50c1bb47694",tags:[Le.SCHOOL,Le.CPP],git_link:"https://github.com/ChrisPis-bit/AdvancedGraphicsAssignment2"},{title:"Simple Path Tracer",description:`During my master's program, I followed a course in <strong>Advanced Graphics</strong>, where I learned about <strong>real-time raytracing</strong>. After completing the course with a <strong>8.9/10</strong>, I decided to use what I learned to develop my own <strong>raytracer</strong>.

The current progress of my raytracer can be seen on the <strong>GitHub page</strong> linked in the bottom left.`,media:"https://github.com/user-attachments/assets/ac4bf908-e621-4eea-acb3-033fa143c486",tags:[Le.PERSONAL,Le.RUST],git_link:"https://github.com/ChrisPis-bit/MyTracer"},{title:"Magicise VR",description:`During my study at the <strong>HvA</strong>, I followed the minor <strong>Virtual Reality</strong>. During this minor, each group was tasked with solving a problem for a company using a VR application.

My group was tasked with creating a VR application that motivates athletes to perform workouts in a virtual environment. During this project, I mainly worked on creating <strong>visual effects</strong> using custom-written <strong>shaders</strong> and the <strong>VFX graph</strong> in Unity.
...
Our game was among the <strong>top 3 rated games</strong> of that semester.`,media:"https://www.youtube.com/embed/gVGPEba4fYc",tags:[Le.SCHOOL,Le.JAVA]}]),t=Et(()=>c.value.every(g=>g.enabled));to(()=>{u({tag:Le.HIGHLIGHTED})});const i=Et(()=>e.value.filter(g=>g.tags.some(p=>{var h;return(h=c.value.find(_=>p===_.value))==null?void 0:h.enabled}))),r=xr(!1),s=xr({title:"",description:"",media:"",tags:[],git_link:void 0,additional_link:void 0}),a=g=>{s.value.title=g.title,s.value.description=g.description,s.value.media=g.media,s.value.tags=g.tags,s.value.git_link=g.git_link,s.value.additional_link=g.additional_link,r.value=!0},o=()=>{r.value=!1},l=Object.keys(Le).map(g=>Le[g]),c=xr(l.map(g=>({value:g,enabled:!1}))),u=g=>{const p=c.value.find(h=>h.value===g.tag);p&&(p.enabled=!p.enabled)},d=()=>c.value.some(g=>g.enabled),f=()=>{const g=d();c.value.forEach(p=>p.enabled=!g)},m=()=>{c.value.forEach(g=>g.enabled=!0)};return(g,p)=>(Ze(),et("div",IM,[_e("div",FM,[_e("div",NM,[_e("div",OM,[UM,_e("div",zM,[kM,BM,_e("div",HM,[(Ze(!0),et(vt,null,zs(c.value,h=>(Ze(),Wi(tl,{tag:h.value,clickable:!0,selected:h.enabled,onTagToggled:u},null,8,["tag","selected"]))),256)),_e("div",{class:"filters-toggle",onClick:p[0]||(p[0]=h=>f()),style:Gr({filter:d()?"none":"brightness(50%)"})},"Toggle all",4)]),_e("div",GM,[(Ze(!0),et(vt,null,zs(qt(i),h=>(Ze(),Wi(uM,{key:h.title,title:h.title,media:h.media,tags:h.tags,description:h.description,git_link:h.git_link,additional_link:h.additional_link,onCardClicked:a},null,8,["title","media","tags","description","git_link","additional_link"]))),128))]),qt(t)?Un("",!0):(Ze(),et("div",{key:0,class:"show-all",onClick:m},WM)),(Ze(),Wi(Nh,{to:"body"},[De(DM,{id:"always-on-top",visible:r.value,title:s.value.title,description:s.value.description,media:s.value.media,git_link:s.value.git_link,tags:s.value.tags,additional_link:s.value.additional_link,onClose:o},null,8,["visible","title","description","media","git_link","tags","additional_link"])]))])])])])]))}});const jM=Ot(qM,[["__scopeId","data-v-dc1ea9d2"]]);const XM={},$M={class:"max-width"},YM=io('<div class="container fade-in" data-v-50f21325><div class="center-content" data-v-50f21325><div class="title" data-v-50f21325> Contact Me </div><div class="seperator" data-v-50f21325></div><div class="icons" data-v-50f21325><a href="mailto:chris.lokhorst@kpnmail.nl?body=Message%20body%20text%20" data-v-50f21325><img src="https://img.icons8.com/ios/100/000000/mail.png" data-v-50f21325></a><a href="https://www.linkedin.com/in/chris-lokhorst-7304b7210/" target="_blank" data-v-50f21325><img src="https://img.icons8.com/ios/100/000000/linkedin-circled--v1.png" data-v-50f21325></a><a href="https://github.com/ChrisPis-bit?tab=repositories" target="_blank" data-v-50f21325><img class="icon" src="https://img.icons8.com/ios11/100/000000/github.png" data-v-50f21325></a></div></div></div>',1),ZM=[YM];function KM(n,e){return Ze(),et("div",$M,ZM)}const JM=Ot(XM,[["render",KM],["__scopeId","data-v-50f21325"]]),QM=`\r
uniform float uTime;\r
