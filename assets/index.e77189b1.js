...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function zc(){return new fn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Za(),fragmentShader:`
		...
		`,blending:Vn,depthTest:!1,depthWrite:!1})}function kc(){return new fn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Za(),fragmentShader:`
...
#define LOW_PRECISION`),e}function Ay(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===fd?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===eg?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===wr&&(e="SHADOWMAP_TYPE_VSM"),e}function Cy(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Ji:case Qi:e="ENVMAP_TYPE_CUBE";break;case so:e="ENVMAP_TYPE_CUBE_UV";break}return e}function Ly(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Qi:e="ENVMAP_MODE_REFRACTION";break}return e}function Ry(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case md:e="ENVMAP_BLENDING_MULTIPLY";break;case bg:e="ENVMAP_BLENDING_MIX";break;case Mg:e="ENVMAP_BLENDING_ADD";break}return e}function Py(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function Dy(n,e,t,i){const r=n.getContext(),s=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Ay(t),c=Cy(t),u=Ly(t),d=Ry(t),f=Py(t),m=t.isWebGL2?"":xy(t),g=yy(s),p=r.createProgram();let h,_,S=t.glslVersion?"#version "+t.glslVersion+`
`:"";t.isRawShaderMaterial?(h=[g].filter(Er).join(`
`),h.length>0&&(h+=`
...
}`;class vb extends Ka{constructor(t){super(t);ke(this,"hitBox");ke(this,"lifetime",30);ke(this,"jitterScale",.2);ke(this,"jitterAcceleration",1e-4);ke(this,"maxJitterSpeed",.5);ke(this,"directionChangeTime",1);ke(this,"_currentLifetime",0);ke(this,"_currentJitterWaitTime",this.directionChangeTime);ke(this,"_model");ke(this,"_material");ke(this,"_speed",5);ke(this,"_mainDirection",new I);ke(this,"_direction",new I);ke(this,"_directionGoal",new I);ke(this,"_directionVelocity",new I);ke(this,"_velocity",new I);const i=new dr(3,3,2,1);this._material=new fn({vertexShader:gb,fragmentShader:_b,uniforms:{uTime:{value:0},uTimeOffset:{value:sn.randFloat(0,1)}},transparent:!0}),this._material.side=fi,this._material.depthWrite=!1;const r=new Nt(i,this._material),s=new ur(4,3.5,4),a=new lb;a.opacity=0,a.transparent=!0,this.hitBox=new Nt(s,a),this._model=r,this._model.add(this.hitBox),t.scene.add(this._model)}get isReusable(){return this._currentLifetime>=this.lifetime}update(){this._material.uniforms.uTime.value=this.scene.time,this._currentLifetime+=this.scene.deltaTime,this._currentJitterWaitTime+=this.scene.deltaTime;const t=new I(0);if(t.copy(this._model.position),this._currentJitterWaitTime>=this.directionChangeTime){this._currentJitterWaitTime=0;const r=new I(sn.randFloat(-1,1),sn.randFloat(-1,1),sn.randFloat(-1,1)).normalize().multiplyScalar(this.jitterScale);this._directionGoal.copy(this._mainDirection).add(r).normalize()}const i=new I;i.subVectors(this._directionGoal,this._direction).normalize().multiplyScalar(this.jitterAcceleration),this._directionVelocity.add(i),this._directionVelocity.length()>this.maxJitterSpeed&&this._directionVelocity.normalize().multiplyScalar(this.maxJitterSpeed),this._direction.add(this._directionVelocity),this._direction.normalize(),this._velocity.copy(this._direction).multiplyScalar(this._speed*this.scene.deltaTime),t.add(this._velocity),this._model.lookAt(t),this._model.rotateX(Math.PI/2),this._model.position.copy(t)}dispose(){this._model.children.forEach(t=>{this._model.remove(t)})}reset(t,i,r,s){this._currentLifetime=0,this._currentJitterWaitTime=this.directionChangeTime,this._model.position.copy(s),this._mainDirection.copy(t),this._direction=new I().copy(this._mainDirection),this._directionGoal=new I().copy(this._direction),this._model.scale.set(i,i,i),this._speed=r,this._velocity.setLength(0),this._directionVelocity.setLength(0)}}class xb extends Ka{constructor(t){super(t);ke(this,"maxButterflies",20);ke(this,"butterflySpawnRate",.7);ke(this,"mainDirection",new I(-1,.3,.05));ke(this,"_currentTime",0);ke(this,"_butterflies",[]);ke(this,"_reusableButterflies",[]);this.spawnInitial()}update(){this._currentTime+=this.scene.deltaTime,this._currentTime>=this.butterflySpawnRate&&(this._currentTime=0,this.spawnButterfly());for(let t=0;t<this._butterflies.length;t++)this._butterflies[t].isReusable&&(this._reusableButterflies.push(this._butterflies[t]),this._butterflies.splice(t,1),t--)}dispose(){this._butterflies=[],this._reusableButterflies=[]}spawnButterfly(){var t;this._reusableButterflies.length>0?t=this._reusableButterflies.pop():(t=new vb(this.scene),this.scene.addObject(t)),this._butterflies.push(t);const i=new I(sn.randFloat(-1,1),sn.randFloat(-1,1),sn.randFloat(-1,1)).multiplyScalar(.2),r=new I().copy(this.mainDirection).add(i).normalize(),s=sn.randFloat(-180,-240);t.reset(r,sn.randFloat(.7,1.5),sn.randFloat(9,12),new I(80,-15,s))}spawnInitial(){for(let t=0;t<5;t++)this.spawnButterfly()}}const yb="/assets/NewMe.b19baf58.jpg",bb={props:["title","description","subjects","image","link"]};const Mb={class:"main"},Sb=["href"],wb=["src"],Eb={class:"description-content"},Tb={class:"title"},Ab={class:"subjects"};function Cb(n,e,t,i,r,s){return Ze(),et("div",Mb,[he("a",{href:t.link,target:"_blank"},[he("img",{src:t.image},null,8,wb)],8,Sb),he("div",Eb,[he("div",Tb,Hi(t.title),1),he("div",null,Hi(t.description),1),he("div",Ab,Hi(t.subjects),1)])])}const yr=Ot(bb,[["render",Cb],["__scopeId","data-v-86fc120a"]]),Lb=Zt({props:["icon","years","desc"],mounted(){const n=this.$refs.text;n!=null&&(n.innerHTML=this.years+(this.years<=1?" Year":" Years"));const e=this.$refs.desc_text;e!=null&&this.desc!=null&&(e.innerHTML=this.desc)}});const Rb=n=>(sr("data-v-7efd5731"),n=n(),or(),n),Pb={class:"content"},Db=["src"],Ib={ref:"text",class:"title"},Fb={ref:"desc_text"},Nb=Rb(()=>he("div",{class:"seperator"},null,-1));function Ob(n,e,t,i,r,s){return Ze(),et("div",Pb,[he("img",{src:n.icon},null,8,Db),he("div",Ib," 7 Years ",512),he("div",Fb,null,512),Nb])}const xn=Ot(Lb,[["render",Ob],["__scopeId","data-v-7efd5731"]]),Zr=n=>(sr("data-v-c4880650"),n=n(),or(),n),Ub=Zr(()=>he("div",{class:"title-centered top-title",id:"about-section"},null,-1)),zb={class:"max-width main"},kb={class:"container"},Bb={class:"timeline-item"},Hb=Zr(()=>he("div",{class:"line-dot"},null,-1)),Gb=io('<div class="top-content fade-in" data-v-c4880650><div class="description" data-v-c4880650><div class="title title-underline" data-v-c4880650> About me </div><div class="main-text" data-v-c4880650><img class="visual" src="'+yb+'" data-v-c4880650> I&#39;m Chris, and welcome to my portfolio page! I&#39;m a programmer from the Netherlands with a strong passion for game development. <br data-v-c4880650><br data-v-c4880650> I hold both a <b data-v-c4880650>master&#39;s</b> and <b data-v-c4880650>bachelor&#39;s</b> degree in computer science, with a focus on game development. During my studies, I completed several successful internships at various companies, which are listed below. <br data-v-c4880650><br data-v-c4880650> My main areas of expertise are <b data-v-c4880650>graphics programming</b>, <b data-v-c4880650>performance optimization</b>, and <b data-v-c4880650>gameplay programming</b>. I also dabble in 3D modeling in my free time and am currently learning the Vulkan graphics API. I&#39;m planning to develop a solo game this year as well! <br data-v-c4880650><br data-v-c4880650> I would describe myself as someone who is constantly eager to learn and expand my knowledge and skills in software development. I&#39;m also a little bit of a perfectionist, so I won&#39;t stop learning until I truly understand what I&#39;m doing. <br data-v-c4880650><br data-v-c4880650><i data-v-c4880650>And a little less technical: I enjoy playing the guitar, gaming, and running!</i></div></div></div>',1),Vb={class:"bottom-content fade-in"},Wb={class:"bottom-item-left"},qb=Zr(()=>he("div",{class:"sub-title sub-title-underline"}," Education ",-1)),jb={class:"experiences"},Xb=Zr(()=>he("div",{class:"sub-title sub-title-underline"}," Experience ",-1)),$b={class:"experiences"},Yb={class:"bottom-item-right"},Zb=Zr(()=>he("div",{class:"sub-title sub-title-underline"}," Skills ",-1)),Kb={class:"skills"},Jb=Zt({__name:"About",setup(n){return(e,t)=>(Ze(),et(vt,null,[Ub,he("div",zb,[he("div",kb,[he("div",Bb,[Hb,he("div",null,[Gb,he("div",Vb,[he("div",Wb,[qb,he("div",jb,[Ie(yr,{title:"Utrecht University",description:"Game and Media Technology Master's degree.",subjects:"Advanced Graphics, Optimization and Vectorization, Serious games, Computer Vision, Motion and Manipulation, AI for Game Technology, AI-driven content generation, Sound and Music Technology",image:"/src/assets/images/Utrecht_University_logo.svg",link:"https://www.uu.nl/"}),Ie(yr,{title:"HvA",description:"HBO-ICT Bachelor's degree - Cum Laude.",subjects:"Programming, Artificial Intelligence, Data-structures and Algorithms, Game Mechanics, Unity, VR/AR Development, Mobile Development, Gameplay Engineering, Project Management, Intercultural Skills",image:"src/assets/images/SocialMedia-HvA.png",link:"https://www.hva.nl/"})]),Xb,he("div",$b,[Ie(yr,{title:"uCrowds",description:"Master thesis internship, developed a Crowd Simulation plugin for Unreal Engine.",image:"https://yt3.googleusercontent.com/ytc/AIdro_ljdVsfdCL4r3_StSlbyYBc5wkHC57GHT836nM_IDXjxQ=s900-c-k-c0x00ffffff-no-rj",link:"https://www.ucrowds.com/"}),Ie(yr,{title:"KLM",description:"HvA Graduation Internship, developed VR applications in Unity.",image:"/src/assets/images/1758957087442.jpg",link:"https://www.linkedin.com/in/klm-xr-center-of-excellence/"}),Ie(yr,{title:"DTT",description:"Internship / Summerjob, developed tools and apps in Unity.",image:"https://s3-eu-west-1.amazonaws.com/sortlist-core-api/x5RpFNJ1g7owYPVUqhSdsZTd",link:"https://www.d-tt.nl/"})])]),he("div",Yb,[Zb,he("div",Kb,[Ie(xn,{icon:"https://i.redd.it/tu3gt6ysfxq71.png",years:"7"}),Ie(xn,{icon:"https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/Logo_C_sharp.svg/960px-Logo_C_sharp.svg.png",years:"7"}),Ie(xn,{icon:"https://upload.wikimedia.org/wikipedia/commons/0/0c/Blender_logo_no_text.svg",years:"4"}),Ie(xn,{icon:"https://raw.githubusercontent.com/isocpp/logos/master/cpp_logo.png",years:"3"}),Ie(xn,{icon:"https://cdn.worldvectorlogo.com/logos/unreal-1.svg",years:"2"}),Ie(xn,{icon:"https://cdn.iconscout.com/icon/free/png-256/free-python-logo-icon-download-in-svg-png-gif-file-formats--technology-social-media-vol-5-pack-logos-icons-2945099.png?f=webp&w=256",years:"2"}),Ie(xn,{icon:"https://cdn.freebiesupply.com/logos/large/2x/opengl-1-logo-png-transparent.png",years:"2"}),Ie(xn,{icon:"https://www.svgrepo.com/show/184143/java.svg",years:"2"}),Ie(xn,{icon:"https://www.vulkan.org/user/themes/vulkan/images/logo/vulkan-logo.svg",years:"1"})])])])])])])])],64))}});const Qb=Ot(Jb,[["__scopeId","data-v-c4880650"]]);var Le=(n=>(n.HIGHLIGHTED="HIGHLIGHTED",n.PERSONAL="PERSONAL",n.SCHOOL="SCHOOL",n.INTERNSHIP="INTERNSHIP",n.C_SHARP="C#",n.CPP="C++",n.RUST="Rust",n.JAVA="JAVA",n.UNITY="Unity",n.UNREAL="Unreal",n.VR="VR",n))(Le||{});const eM=Object.freeze({HIGHLIGHTED:{color:"rgb(189, 172, 75)",text:"Highlighted"},PERSONAL:{color:"rgb(0, 165, 0)",text:"Personal"},SCHOOL:{color:"rgb(0, 123, 255)",text:"School"},INTERNSHIP:{color:"rgb(255, 165, 0)",text:"Internship"},["C#"]:{color:"rgb(165, 100, 165)",text:"C#"},["C++"]:{color:"rgb(0, 100, 255)",text:"C++"},Rust:{color:"rgb(255, 69, 0)",text:"Rust"},JAVA:{color:"rgb(220, 140, 0)",text:"Java"},Unity:{color:"rgb(100, 100, 100)",text:"Unity"},Unreal:{color:"rgb(84, 124, 134)",text:"Unreal"},VR:{color:"rgb(200,130,90)",text:"VR"}}),tM=Zt({__name:"Tag",props:{tag:null,clickable:{type:Boolean},selected:{type:Boolean}},emits:["tag-toggled"],setup(n,{emit:e}){const t=n,i=eM[t.tag],r=()=>{!t.clickable||e("tag-toggled",{tag:t.tag})};return(s,a)=>(Ze(),et("div",{class:Ws(["tag-item"]),style:Wr({backgroundColor:qt(i).color,filter:n.selected?"none":"brightness(50%)",cursor:n.clickable?"pointer":"default",outline:n.tag==qt(Le).HIGHLIGHTED?"2px solid rgb(255, 255, 0)":"none"}),onClick:r},Hi(qt(i).text),5))}});const Ja=Ot(tM,[["__scopeId","data-v-80a54e7b"]]);function zd(n){const e=/(?:youtube\.com\/(?:[^\/\n\s]+\/\S+\/|(?:v|e(?:mbed)?)\/|(?:[^\/\n\s]+)\/?\S*?\?v=)|youtu\.be\/)([a-zA-Z0-9_-]{11})/,t=n.match(e);return t?t[1]:null}function nM(n){return`https://img.youtube.com/vi/${n}/maxresdefault.jpg`}const iM={class:"item_content"},rM=["src"],sM={class:"title"},oM=["innerHTML"],aM={class:"tag-container"},lM=Zt({__name:"Card",props:{tags:null,title:null,media:null,description:null,git_link:null,additional_link:null},emits:["card-clicked"],setup(n,{emit:e}){const t=n,i=250,r=()=>{if(t.description.length<i)return t.description;let o=t.description.slice(0,i);const l=o.lastIndexOf(" ");return l===-1?o:o.slice(0,l)+"..."},s=()=>{let o=t.media,l=zd(o);return l&&(o=nM(l)),o},a=()=>{e("card-clicked",{title:t.title,description:t.description,media:t.media,tags:t.tags,git_link:t.git_link,additional_link:t.additional_link})};return(o,l)=>(Ze(),et("div",{class:"item",onClick:a},[he("div",iM,[he("img",{class:"media",src:s()},null,8,rM),he("div",sM,Hi(t.title),1),he("div",{innerHTML:r(),class:"description"},null,8,oM),he("div",aM,[(Ze(!0),et(vt,null,zs(t.tags,(c,u)=>(Ze(),qi(Ja,{key:u,tag:c,clickable:!1,selected:!0},null,8,["tag"]))),128))])])]))}});const cM=Ot(lM,[["__scopeId","data-v-5d4258f3"]]);const Kr=n=>(sr("data-v-0f989ad2"),n=n(),or(),n),uM={class:"flex"},dM={class:"description"},fM={class:"timeline-item"},hM=Kr(()=>he("div",{class:"line-dot"},null,-1)),pM={class:"title title-underline"},mM=["innerHTML"],gM=Kr(()=>he("div",{class:"seperator"},null,-1)),_M={class:"visual"},vM=["src"],xM=["href"],yM=["src"],bM=["src"],MM={class:"tag-container"},SM=["href"],wM=Kr(()=>he("img",{class:"icon",src:"https://img.icons8.com/ios11/512/000000/github.png"},null,-1)),EM=[wM],TM=["href"],AM=Kr(()=>he("img",{class:"icon",src:"https://img.icons8.com/ios11/512/000000/link.png"},null,-1)),CM=[AM],LM=Kr(()=>he("div",{class:"content-sharp"},null,-1)),RM=Zt({__name:"CardOverlay",props:{visible:null,title:null,description:null,media:null,tags:null,git_link:null,additional_link:null},emits:["close"],setup(n,{emit:e}){const t=n,i=()=>{e("close")},r=()=>zd(t.media)!=null;return(s,a)=>n.visible?(Ze(),et("div",{key:0,class:"overlay fade-in-animation",onClick:i},[he("div",{class:"content",onClick:a[0]||(a[0]=hp(()=>{},["stop"]))},[he("img",{class:"close",src:"https://img.icons8.com/ios11/512/000000/cancel.png",onClick:i}),he("div",uM,[he("div",dM,[he("div",fM,[hM,he("div",null,[he("div",pM,Hi(n.title),1),he("div",{innerHTML:n.description,class:"main-text"},null,8,mM)])])]),gM,he("div",_M,[r()?(Ze(),et("iframe",{key:0,class:"media media-video",src:n.media},null,8,vM)):Un("",!0),n.git_link||n.additional_link?(Ze(),et("a",{key:1,href:n.additional_link?n.additional_link:n.git_link,target:"_blank"},[r()?Un("",!0):(Ze(),et("img",{key:0,class:"media",src:n.media},null,8,yM))],8,xM)):Un("",!0),!n.git_link&&!n.additional_link&&!r()?(Ze(),et("img",{key:2,class:"media",src:n.media},null,8,bM)):Un("",!0),he("div",MM,[(Ze(!0),et(vt,null,zs(t.tags,(o,l)=>(Ze(),qi(Ja,{key:l,tag:o,clickable:!1,selected:!0},null,8,["tag"]))),128))]),he("div",null,[n.git_link!=null?(Ze(),et("a",{key:0,href:n.git_link,target:"_blank"},EM,8,SM)):Un("",!0),n.additional_link!=null?(Ze(),et("a",{key:1,href:n.additional_link,target:"_blank"},CM,8,TM)):Un("",!0)])])]),LM])])):Un("",!0)}});const PM=Ot(RM,[["__scopeId","data-v-0f989ad2"]]),lo=n=>(sr("data-v-36eb78da"),n=n(),or(),n),DM={class:"main-bg"},IM={class:"max-width"},FM={class:"container"},NM={class:"timeline-item"},OM=lo(()=>he("div",{class:"line-dot"},null,-1)),UM={class:"main fade-in"},zM=lo(()=>he("div",{class:"title title-underline"}," Projects ",-1)),kM=lo(()=>he("div",{class:"sub-text main-text"},[di("Filter by toggling tags. "),he("br"),di(" For more details, you can click on the project cards. ")],-1)),BM={class:"filters"},HM={class:"cards"},GM=lo(()=>he("u",null,[he("a",null,"Show All")],-1)),VM=[GM],WM=Zt({__name:"Projects",setup(n){const e=Mr([{title:"Unreal Engine TerraCrowds Plugin",description:`For my <strong>master\u2019s thesis</strong>, I developed a <strong>crowd simulation plugin for Unreal Engine</strong> in collaboration with uCrowds. The plugin enables real-time simulation of up to 100,000 agents in complex 3D game environments. Crowd flow can be directed through a graph-based waypoint system, allowing users to modify waypoints and obstacles dynamically during simulation.
...
The thesis received a <strong>final grade of 8.5/10</strong>. During development, the plugin was <strong>featured at Unreal Fest (Orlando)</strong> in a live demo by uCrowds.`,media:"https://youtube.com/embed/No76LzYcdUc",tags:[Le.HIGHLIGHTED,Le.INTERNSHIP,Le.UNREAL,Le.CPP]},{title:"The Reverse Turing Test",description:`<strong>Disclaimer:</strong> This project does not reflect my personal opinion of the usage of AI in the gaming industry. The project made no profits and was purely educational in regards to presenting the limitations of generative AI. My personal belief is that AI should never replace human art, not just from a moral standpoint but also in terms of resulting quality.

During my master\u2019s program, I took a course on AI content generation. As part of this course, my team and I developed a game prototype titled <strong>Reverse Turing Test</strong>, in which the player must convince a <strong>large language model (LLM)</strong> that they are an AI rather than a human. The project was created using exclusively <strong>AI-generated 3D models and music</strong>.
...
Game jams give me the opportunity to rapidly prototype ideas and explore new engines, languages, and game development techniques. For example, <strong>Roombash</strong> allowed me to learn the <strong>Godot engine</strong>, while <strong>Still Waters</strong> gave me a chance to experiment with creating atmosphere in a horror setting. One of my projects, <strong>Super Mega Power Golf 3D</strong>, was particularly well-received, becoming the <strong>second most-rated game</strong> out of 821 entries.`,media:"https://static.itch.io/images/logo-white-new.svg",tags:[Le.PERSONAL],additional_link:"https://chrispies.itch.io/"},{title:"Jibblets (GoedWare Gamejam Winner)",description:`I participated in the 16th edition of the <strong>GoedWare Game Jam</strong>, where the theme was <strong>\u201CYou can\u2019t save them all\u201D</strong>. My submission, \u201CJibblets\u201D, placed <strong>#1 in the jury vote</strong> and <strong>#2 in the public vote</strong>.

I joined the jam as a solo developer, taking full responsibility for <strong>programming</strong>, <strong>3D modelling</strong>, <strong>sound design</strong>, and <strong>level design</strong>. I created a puzzle game to improve my puzzle design skills while aiming for a cohesive art style combining realistic textures with stylized VFX.

The game revolves around small characters called Jibblets, who are subjected to cruel experiments. The player must guide them to the exit, solving puzzles that require sacrificing some Jibblets so others can survive.
...
<ul><li>A blood rendering system using <strong>instanced rendering</strong> with a dither shader for transparency</li><li>A <strong>modular and extendable trigger system</strong> for interactions between buttons, lasers and platforms</li><li><strong>Custom shaders</strong>, including height-based fog</li><li>Fully <strong>modeled and animated 3D character</strong></li></ul>
...
Through this project, I gained experience in <strong>setting up multiplayer games in Unity</strong> and applied various <strong>optimization techniques</strong> to efficiently render multiple high-quality 3D models in VR, ensuring smooth performance on standalone mobile hardware. I also designed <strong>interactable 3D interfaces</strong>, enabling users to play animations of ground vehicles moving around the airplane.
...
Our game was among the <strong>top 3 rated games</strong> of that semester.`,media:"https://www.youtube.com/embed/gVGPEba4fYc",tags:[Le.SCHOOL,Le.JAVA]}]),t=Et(()=>c.value.every(g=>g.enabled));to(()=>{u({tag:Le.HIGHLIGHTED})});const i=Et(()=>e.value.filter(g=>g.tags.some(p=>{var h;return(h=c.value.find(_=>p===_.value))==null?void 0:h.enabled}))),r=Mr(!1),s=Mr({title:"",description:"",media:"",tags:[],git_link:void 0,additional_link:void 0}),a=g=>{s.value.title=g.title,s.value.description=g.description,s.value.media=g.media,s.value.tags=g.tags,s.value.git_link=g.git_link,s.value.additional_link=g.additional_link,r.value=!0},o=()=>{r.value=!1},l=Object.keys(Le).map(g=>Le[g]),c=Mr(l.map(g=>({value:g,enabled:!1}))),u=g=>{const p=c.value.find(h=>h.value===g.tag);p&&(p.enabled=!p.enabled)},d=()=>c.value.some(g=>g.enabled),f=()=>{const g=d();c.value.forEach(p=>p.enabled=!g)},m=()=>{c.value.forEach(g=>g.enabled=!0)};return(g,p)=>(Ze(),et("div",DM,[he("div",IM,[he("div",FM,[he("div",NM,[OM,he("div",UM,[zM,kM,he("div",BM,[(Ze(!0),et(vt,null,zs(c.value,h=>(Ze(),qi(Ja,{tag:h.value,clickable:!0,selected:h.enabled,onTagToggled:u},null,8,["tag","selected"]))),256)),he("div",{class:"filters-toggle",onClick:p[0]||(p[0]=h=>f()),style:Wr({filter:d()?"none":"brightness(50%)"})},"Toggle all",4)]),he("div",HM,[(Ze(!0),et(vt,null,zs(qt(i),h=>(Ze(),qi(cM,{key:h.title,title:h.title,media:h.media,tags:h.tags,description:h.description,git_link:h.git_link,additional_link:h.additional_link,onCardClicked:a},null,8,["title","media","tags","description","git_link","additional_link"]))),128))]),qt(t)?Un("",!0):(Ze(),et("div",{key:0,class:"show-all",onClick:m},VM)),(Ze(),qi(Ph,{to:"body"},[Ie(PM,{id:"always-on-top",visible:r.value,title:s.value.title,description:s.value.description,media:s.value.media,git_link:s.value.git_link,tags:s.value.tags,additional_link:s.value.additional_link,onClose:o},null,8,["visible","title","description","media","git_link","tags","additional_link"])]))])])])])]))}});const qM=Ot(WM,[["__scopeId","data-v-36eb78da"]]);const jM={},XM={class:"max-width"},$M=io('<div class="container fade-in" data-v-553e2fdf><div class="center-content" data-v-553e2fdf><div class="title" data-v-553e2fdf> Contact Me </div><div class="seperator" data-v-553e2fdf></div><div class="icons" data-v-553e2fdf><a href="mailto:chris.lokhorst@kpnmail.nl?body=Message%20body%20text%20" data-v-553e2fdf><img src="https://img.icons8.com/ios/100/000000/mail.png" data-v-553e2fdf></a><a href="https://www.linkedin.com/in/chris-lokhorst-7304b7210/" target="_blank" data-v-553e2fdf><img src="https://img.icons8.com/ios/100/000000/linkedin-circled--v1.png" data-v-553e2fdf></a><a href="https://github.com/Chrisp-byte?tab=repositories" target="_blank" data-v-553e2fdf><img class="icon" src="https://img.icons8.com/ios11/100/000000/github.png" data-v-553e2fdf></a></div></div></div>',1),YM=[$M];function ZM(n,e){return Ze(),et("div",XM,YM)}const KM=Ot(jM,[["render",ZM],["__scopeId","data-v-553e2fdf"]]),JM=`\r
uniform float uTime;\r
...
}`;class nS extends Ka{constructor(t){super(t);ke(this,"speed",1);ke(this,"startZ",-250);ke(this,"segmentDist",0);ke(this,"mat");ke(this,"model");const i=getComputedStyle(document.documentElement).getPropertyValue("--color-background-dark").trim(),r=new dr(1e3,600,500,300);this.segmentDist=500/250,this.mat=new fn({vertexShader:JM,fragmentShader:QM,uniforms:{uTime:{value:0},uFogColor:{value:new Ke(i)},uOffset:{value:0}}}),this.model=new Nt(r,this.mat),this.model.rotateX(-Math.PI/2),this.model.scale.setX(1),this.model.scale.setY(1),this.model.position.setY(-30),this.model.position.setZ(this.startZ),t.scene.add(this.model)}update(){this.mat.uniforms.uTime.value=this.scene.time;let t=this.scene.time%this.speed/this.speed;this.model.position.setZ(this.startZ+this.segmentDist*t),this.mat.uniforms.uOffset.value=this.segmentDist*Math.floor(this.scene.time/this.speed)}dispose(){this.scene.scene.remove(this.model)}}const iS=io('<div class="main" data-v-68652f5f><div class="canvas-viewport" data-v-68652f5f><canvas id="bg" data-v-68652f5f></canvas><div class="max-width" data-v-68652f5f><div class="name-container" data-v-68652f5f><div data-v-68652f5f><div class="name-1" data-v-68652f5f>Hi, I&#39;m</div><div class="name-2" data-v-68652f5f>Chris Lokhorst</div></div></div></div></div></div>',1),rS=Zt({__name:"Home",setup(n){let e=!1,t;return to(()=>{const i=document.querySelectorAll(".fade-in"),r=new IntersectionObserver((h,_)=>{h.forEach(S=>{S.isIntersecting&&(S.target.classList.add("show"),_.unobserve(S.target))})},{root:null,rootMargin:"0px 0px -100px 0px",threshold:0});i.forEach(h=>r.observe(h)),e=!0;const s=document.getElementById("bg");if(!s)return;const a=new ab,o=new Lt(75,s.offsetWidth/s.offsetHeight,.1,500),l=new Od({canvas:s,alpha:!0});l.setPixelRatio(window.devicePixelRatio),o.position.setZ(30),o.position.setX(0),t=new mb(a,o,l);const c=new db(16777215),u=new fb(16777215,.1);c.position.set(30,10,30),c.rotation.x=-90,c.rotation.y=45,c.angle=10,c.decay=2,t.scene.add(c),t.scene.add(u),t.addObject(new xb(t)),t.addObject(new nS(t));const d=new dr(240,240,1,1),f=new fn({vertexShader:eS,fragmentShader:tS,uniforms:{uTime:{value:0}},transparent:!0}),m=new Nt(d,f);m.position.setY(60),m.position.setZ(-470),t.scene.add(m),t.update(0);const g=new hb;function p(h){if(!e)return;t.update(h),g.getDelta();const _=g.getElapsedTime();f.uniforms.uTime.value=_,requestAnimationFrame(p)}p(0)}),Ua(()=>{e=!1,t.dispose()}),(i,r)=>(Ze(),et(vt,null,[iS,Ie(Qb),Ie(qM,{id:"projects-section"}),Ie(KM,{id:"contact-section"})],64))}});const Ts=Ot(rS,[["__scopeId","data-v-68652f5f"]]);const sS=[{path:"/",component:Ts},{path:"/about",component:Ts},{path:"/projects",component:Ts},{path:"/contact",component:Ts}],oS=bm({history:Op(),routes:sS,scrollBehavior(n,e,t){if(n.hash)return{el:n.hash,behavior:"smooth"};let i="";switch(n.path){case"/about":i="#about-section";break;case"/projects":i="#projects-section";break;case"/contact":i="#contact-section";break;default:i="#home-section"}return i?{el:i,behavior:"smooth"}:{top:0}}}),kd=gp(Km);kd.use(oS);kd.mount("#app");
